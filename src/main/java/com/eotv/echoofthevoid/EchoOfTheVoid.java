...
import com.eotv.echoofthevoid.worldgen.UncannyWorldgenIntegrityCheck;
...
public class EchoOfTheVoid {
    ...
    public EchoOfTheVoid(IEventBus modEventBus, ModContainer modContainer) {
        ...
        NeoForge.EVENT_BUS.addListener(UncannyEventController::onPlayerChangedDimension);
        ...
        NeoForge.EVENT_BUS.addListener(UncannyWeatherSystem::onBlockPlaced);
        NeoForge.EVENT_BUS.addListener(UncannyWeatherSystem::onBlockBroken);
        ...
        NeoForge.EVENT_BUS.addListener(MinecraftNativeAnomalySystem::onEntityInteract);
        ...
        NeoForge.EVENT_BUS.addListener(MinecraftNativeAnomalySystem::onLivingDeath);
        NeoForge.EVENT_BUS.addListener(MinecraftNativeAnomalySystem::onPlayerLogout);
        NeoForge.EVENT_BUS.addListener(MinecraftNativeAnomalySystem::onPlayerChangedDimension);
        ...
        NeoForge.EVENT_BUS.addListener(ApprovedVanillaVariantSystem::onFinalizeSpawn);
        NeoForge.EVENT_BUS.addListener(ApprovedVanillaVariantSystem::onEntityTick);
        NeoForge.EVENT_BUS.addListener(ApprovedVanillaVariantSystem::onLivingIncomingDamage);
        NeoForge.EVENT_BUS.addListener(ApprovedVanillaVariantSystem::onProjectileImpact);
        NeoForge.EVENT_BUS.addListener(ApprovedSpecialSystem::onSoundAtPosition);
        NeoForge.EVENT_BUS.addListener(ApprovedSpecialSystem::onSoundAtEntity);
        NeoForge.EVENT_BUS.addListener(ApprovedSpecialSystem::onLivingIncomingDamage);
        NeoForge.EVENT_BUS.addListener(UncannySpecialRewardSystem::onLivingDrops);
        NeoForge.EVENT_BUS.addListener(UncannyCommandRegistry::onRegisterCommands);
        NeoForge.EVENT_BUS.addListener(UncannyWorldgenIntegrityCheck::onServerStarted);
